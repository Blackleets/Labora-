...
const MobileBotanicalScene: React.FC = () => (
  <svg
    viewBox="0 0 260 330"
    className="pointer-events-none absolute -right-7 top-4 h-[330px] w-[245px] select-none"
    aria-hidden="true"
  >
    <defs>
      <linearGradient id="laboraLeaf" x1="0" y1="0" x2="1" y2="1">
        <stop offset="0" stopColor="#193F31" />
        <stop offset="1" stopColor="#56725E" />
      </linearGradient>
      <linearGradient id="laboraPot" x1="0" y1="0" x2="1" y2="1">
        <stop offset="0" stopColor="#F4ECDD" />
        <stop offset="1" stopColor="#D8CCB8" />
      </linearGradient>
      <filter id="laboraSoftShadow" x="-30%" y="-30%" width="160%" height="160%">
    ...
    <g filter="url(#laboraSoftShadow)">
      <path d="M157 203 H241 L232 283 Q231 296 217 299 H178 Q165 296 164 283 Z" fill="url(#laboraPot)" />
    ...
    <g filter="url(#laboraSoftShadow)" transform="translate(25 224)">
...
const MobileManagerIllustration: React.FC = () => (
  <svg viewBox="0 0 250 175" className="h-[170px] w-[235px]" aria-hidden="true">
    <g>
    ...
    <div id="rider-dashboard" className="mx-auto max-w-6xl pb-12">
      <div className="md:hidden">
        <section className="relative overflow-hidden bg-[#F8F4EC] px-6 pb-7 pt-7">
          ...
          <p className="mt-12 text-[10px] font-extrabold uppercase tracking-[0.32em] text-[#587064]">{dateLabel}</p>

          <div className="relative min-h-[345px] pt-12">
            <div className="relative z-10 max-w-[73%]">
              <h1 className="text-[3.45rem] font-semibold leading-[0.96] tracking-[-0.065em] text-[#0B412F]">
                Tu trabajo,<br />en orden.
              </h1>
              <p className="mt-5 text-[1.65rem] font-medium tracking-[-0.035em] text-[#697A70]">Tu gestor, cerca.</p>
            </div>
        ...
        <section className="bg-[#F8F4EC] px-6 pb-7 pt-6">
          ...
          >
            ...
            <span className="min-w-0 flex-1">
              ...
              <span className="mt-1 block line-clamp-2 text-[13px] leading-relaxed text-[#738078]">
        ...
        <details className="group mx-6 mb-5 rounded-[24px] border border-[#DED7C9] bg-[#FFFCF6]">
          ...
          <div className="border-t border-[#E7E0D5] px-5 pb-5 pt-4">
            ...
            <div className="mt-4 grid grid-cols-2 gap-2">
              ...
              <MiniMetric label="€/h bruto" value={todayWorkedHours > 0 ? formatCurrencyPrecise(todayGrossPerHour) : '—'} emphasis />
            </div>

            <button
              type="button"
              onClick={() => setIsGasModalOpen(true)}
              className="mt-4 flex w-full items-center justify-center gap-2 rounded-2xl border border-[#E7D3C8] bg-[#FFF4EE] px-4 py-3 text-xs font-extrabold text-[#B85A38]"
            >
              <Fuel size={16} />
