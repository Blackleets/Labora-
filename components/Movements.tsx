  ...
  return (
    <div className="space-y-6 pb-20 lg:pb-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h2 className="text-3xl font-bold text-[var(--labora-ink)]">Movimientos</h2>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <button 
            ...
            className="flex items-center justify-center gap-2 px-4 py-2.5 bg-gray-100 hover:bg-gray-200 text-[var(--labora-ink-soft)] rounded-xl text-sm font-bold transition-colors"
          >
            <Download size={18} />
          ...
          <div className="flex bg-[var(--labora-surface)] p-1 rounded-xl shadow-sm border border-gray-100">
            <button
              ...
              className={`flex items-center gap-2 px-6 py-2.5 rounded-lg text-sm font-bold transition-all duration-300 ${
                activeTab === 'incomes' 
                  ...
                  : 'text-gray-500 hover:text-[var(--labora-ink-soft)]'
              }`}
            >
              <Wallet size={18} />
              Ingresos
        ...
        <div className="flex flex-1 flex-col sm:flex-row gap-3 w-full">
          <div className="relative flex-1">
             ...
             <input 
               ...
               className="w-full pl-9 pr-3 py-2 bg-[var(--labora-surface-2)] border border-[var(--labora-border)] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#2D6CDF] text-[var(--labora-ink-soft)]"
               placeholder="Desde"
             />
          </div>
