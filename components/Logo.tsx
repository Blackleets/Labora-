...
const BrandMarkSvg = ({ size }: { size: number }) => (
  <svg width={size} height={size} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="block h-full w-full">
    <defs>
      <linearGradient id="laboraGreen" x1="7" y1="7" x2="38" y2="40" gradientUnits="userSpaceOnUse">
        <stop stopColor="#082F25" />
        <stop offset="1" stopColor="#1B6549" />
      </linearGradient>
      <linearGradient id="laboraOrange" x1="34" y1="25" x2="58" y2="57" gradientUnits="userSpaceOnUse">
        <stop stopColor="#C74F1F" />
        <stop offset="1" stopColor="#E57A35" />
      </linearGradient>
    </defs>

    <rect x="21" y="2" width="22" height="34" rx="11" fill="url(#laboraGreen)" />
    <rect x="2" y="21" width="34" height="22" rx="11" fill="url(#laboraGreen)" />
    <rect x="28" y="21" width="34" height="22" rx="11" fill="url(#laboraOrange)" />
    <rect x="21" y="28" width="22" height="34" rx="11" fill="url(#laboraOrange)" />
  ...
  return (
    <div
      ...
      style={{
        width: config.mark,
        height: config.mark,
        filter: 'drop-shadow(0 8px 12px rgba(28, 74, 52, 0.10))'
      }}
