# Shared UI primitives — Labora+ Ghibli

Framework: Vite + React 18 + TypeScript + Tailwind utility classes + Lucide. No shadcn.
Shared scenic + brand primitives used across Login / Dashboard / Sidebar.
...
## Inline auth field chrome (from Login)
- `inputClass`: `rounded-2xl border border-[#E8DFC8] bg-[#FFFEFB] ... focus:border-[#2F5D4A]/45 focus:ring-4 focus:ring-[#2F5D4A]/10`
- `labelClass`: uppercase 11px tracking, muted `#6B645C`
- CTA: `bg-gradient-to-b from-[#D97757] to-[#C96846]` white bold
