...
create trigger expenses_lock_delete_tombstone
...
create trigger incomes_lock_delete_tombstone
...
create trigger documents_lock_delete_tombstone
...
create trigger aa_expenses_lock_write_tombstone
before insert or update of id, user_id on public.expenses
for each row execute function private.lock_operational_entity('expenses');
create trigger ab_expenses_reject_tombstoned_write
before insert or update of id, user_id on public.expenses
...
create trigger aa_incomes_lock_write_tombstone
before insert or update of id, user_id on public.incomes
for each row execute function private.lock_operational_entity('incomes');
create trigger ab_incomes_reject_tombstoned_write
before insert or update of id, user_id on public.incomes
...
create trigger aa_documents_lock_write_tombstone
before insert or update of id, user_id on public.documents
for each row execute function private.lock_operational_entity('documents');
create trigger ab_documents_reject_tombstoned_write
before insert or update of id, user_id on public.documents
